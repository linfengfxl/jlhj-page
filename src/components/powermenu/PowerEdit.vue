        ...
        <div class="page-form">
          <Form :model="formItem" ref="form" :label-width="100" :rules="ruleValidate" class="form-item">
            ...
            <FormItem label="功能点ID" prop="powerId" >
               <InputNumber  :max="999999" :min="0" v-model="formItem.powerId" :disabled="this.isEdit"></InputNumber> 
            </FormItem>  
            ...
            <FormItem label="是否显示">
              <i-switch v-model="formItem.isShow"
  ...
  export default {
    ...
    methods: {
      ...
      if (this.isEdit) {
        ...
        msg = '添加成功';
        if(this.$user.empInfo.id){
          this.formItem.creator=this.$user.empInfo.id;
          this.oriItem.creator=this.$user.empInfo.id;
        }
      }
      this.loading = 1;
