...
cfg.forms = [
  ...
  {module:'2',key:'clrkd',title:'材料入库单',startUrl:'/storage/instock/start',handleUrl:'/storage/instock/handle',viewUrl:'/storage/instock/view',printUrl:'bill/rk/',defineIds:[2,14]},
  ...
  {module:'3',key:'ysxp',title:'运输小票',startUrl:'/transport/order/start',handleUrl:'/transport/order/handle',viewUrl:'/transport/order/view',printUrl:'bill/ysxp/',defineIds:[13]}, 
  ...
  {module:'9',key:'cbfxb',title:'成本分析表',startUrl:'/project/analysis/start',handleUrl:'/project/analysis/handle',viewUrl:'/project/analysis/view',defineIds:[15]},
  {module:'9',key:'gcjsb',title:'工程结算表',startUrl:'/project/bill/start',handleUrl:'/project/bill/handle',viewUrl:'/project/bill/view',defineIds:[16]},
